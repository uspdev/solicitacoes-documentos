...
{{-- é necessário passar
  ...
  $modal['title']
--}}
<div class="modal fade" id="modal-adicionar-pessoas" data-backdrop="static" tabindex="-1" aria-labelledby="modalPortariaLabel" aria-hidden="true">
        ...
        <div class="list_table_div_form">
          {{ html()->form('post', $modal['url'])->open() }}
            ...
            <div class="form-group row">
              {{ html()->label('codpes', 'Nome')->class('col-form-label col-sm-2') }}
              <div class="col-sm-10">
                {{ html()->select('codpes', [])->class('form-control') }}
              </div>
            </div>
...
<script>
  $(document).ready(function() {
    var pessoasForm = $('#modal-adicionar-pessoas')
