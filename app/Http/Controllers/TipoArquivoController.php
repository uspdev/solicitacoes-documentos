...
class TipoArquivoController extends Controller
{
    ...
    public function store(TipoArquivoRequest $request)
    {
        ...
        \UspTheme::activeUrl('tiposarquivo');
        return redirect()->route('tiposarquivo.index')->with($this->monta_compact_index());    // se fosse return view, um eventual F5 do usuário duplicaria o registro... POSTs devem ser com redirect
    }
