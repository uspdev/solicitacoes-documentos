...
class ArquivoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        \UspTheme::activeUrl('solicitacoesdocumentos');
        return redirect()->to(url('solicitacoesdocumentos/edit/' . $solicitacaodocumento->id))->with($this->monta_compact($solicitacaodocumento, 'edit', 'arquivos'));    // se fosse return view, um eventual F5 do usuário duplicaria o registro... POSTs devem ser com redirect
    }
